...
export const ConnectionLayer: React.FC<ConnectionLayerProps> = ({ 
  ...
  const getCardEdgePoint = (center: Point, target: Point): Point => {
    const w = CARD_WIDTH;
    const h = CARD_HEIGHT;
  ...
  // Color Constants
  const COLOR_DEFAULT = "#3b82f6"; // UI Blue 500
  ...
  return (
    <svg className="absolute top-0 left-0 w-full h-full pointer-events-none overflow-visible">
      <defs>
        ...
        */}
        <marker id="marker-arrow-end" markerWidth="20" markerHeight="20" refX="14" refY="10" orient="auto" markerUnits="userSpaceOnUse" overflow="visible">
          <path d="M2,5 L2,15 L14,10 z" fill={COLOR_DEFAULT} />
        </marker>
        <marker id="marker-arrow-end-sel" markerWidth="20" markerHeight="20" refX="14" refY="10" orient="auto" markerUnits="userSpaceOnUse" overflow="visible">
        ...
        {/* 
            ...
            Points Left.
        */}
        <marker id="marker-arrow-start" markerWidth="20" markerHeight="20" refX="6" refY="10" orient="auto" markerUnits="userSpaceOnUse" overflow="visible">
          <path d="M18,5 L18,15 L6,10 z" fill={COLOR_DEFAULT} />
        </marker>
        <marker id="marker-arrow-start-sel" markerWidth="20" markerHeight="20" refX="6" refY="10" orient="auto" markerUnits="userSpaceOnUse" overflow="visible">
      ...
      {connections.map(conn => {
        ...
        const start = getCardEdgePoint(centerStart, centerEnd);
        const end = getCardEdgePoint(centerEnd, centerStart);
