...
import { authService, isElectronRuntimeEnvironment } from '../src/integrations/supabase/auth-service';
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-200">
                ...
                <div className="p-8">
                    ...
                    {/* Google Button - open provider URL in external browser */}
                    <button
                        onClick={handleGoogleLogin}
                        className="w-full flex items-center justify-center gap-2 bg-white border border-gray-200 text-gray-700 font-medium p-3 rounded-xl hover:bg-gray-50 transition-colors mb-2"
                    >
                    ...
                    <p className="text-xs text-gray-500 text-center mb-6">
                        {isElectronRuntimeEnvironment()
                            ? 'Opens in your browser. Return to the app after signing in.'
                            : 'Google sign-in stays in this window.'}
                    </p>
